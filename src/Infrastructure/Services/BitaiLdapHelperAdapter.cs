...
public sealed class BitaiLdapHelperAdapter : IBitaiLdapHelperAdapter
{
   ...
   public Task<Result<AuthenticationResultDto>> AuthenticateAsync(string server, CatalogType catalogType, string username, string password, bool validateUserExists, CancellationToken cancellationToken)
